    ...
    <Sidebar>
      <SidebarHeader className="border-b border-white/10">
        <div className="px-2 py-2">
          <h1 className="text-lg font-bold text-white tracking-wide">CLAUDE.md</h1>
          <p className="text-xs text-[#a0aec0]">Rule Management Dashboard</p>
        </div>
      </SidebarHeader>
      <SidebarContent>
        <SidebarGroup>
      ...
      <SidebarFooter>
        <div className="px-2 py-1 text-xs text-[#718096]">v0.1.0</div>
      </SidebarFooter>
    </Sidebar>
  );
}
