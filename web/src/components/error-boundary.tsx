    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center py-16 space-y-4">
          <div className="w-16 h-16 rounded-full bg-[color-mix(in_oklch,var(--danger)_10%,transparent)] flex items-center justify-center">
          ...
          <button
            ...
            className="px-4 py-2 text-sm rounded-[var(--radius-sm)] bg-[var(--accent)] text-[var(--accent-on)] hover:opacity-90 transition-opacity"
          >
