...
const en: Dict = {
  ...
  'table.lastCited': 'Last Cited',
  'table.status': 'Status',
  'table.rulesChanged': 'Rules Changed',
  'table.task': 'Task',
  'rules.title': 'Rules',
  ...
  'rules.sort.default': 'Default',
  'rules.sort.matchCount': 'Match Count',
  'rules.sort.coverage': 'Coverage',
  'rules.sort.depth': 'Depth',
  'rules.sort.share': 'Citation Share',
  ...
  'editor.noPublishHistory': 'No publish history yet',
  ...
  'analytics.confidence.source.mcp': 'MCP Tool',
  'analytics.confidence.source.stop': 'Hook (Stop)',
  'analytics.confidence.source.posttool': 'Hook (PostToolUse)',
  'analytics.coldRules': 'Cold Rules',
  'analytics.neverCited': 'Never cited',
  'analytics.noData': 'No data available',
  'analytics.allRulesActive': 'All rules are active',
  ...
  'sidebar.subtitle': 'Rules · Sessions · Analytics',
  'sidebar.buildStatus': 'Build status',
  'sidebar.ok': 'OK',
  'sidebar.error': 'Error',
